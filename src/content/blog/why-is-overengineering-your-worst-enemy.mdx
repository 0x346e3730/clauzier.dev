...
<OptimizedImage src="/images/blog/hashmapfix_cpu_chart.png" alt="Spoiler: CPU Chart" caption="CPU usage (and spikes) before and after the fix" width={800} height={400} />

<OptimizedImage src="/images/blog/hashmapfix_ram_chart.png" alt="Spoiler: RAM Chart" caption="Memory usage before and after the fix" width={800} height={400} />
